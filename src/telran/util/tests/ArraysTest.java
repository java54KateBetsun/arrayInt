...
int [] array = {10, 25, 30, 40, 100};
	...
	void arraycopyTest() {
		...
		int[] expected = {10, 25, 10, 20, 100}; // 10, 20 instead 30,40;
	...
	void binarySearchIntTest() {
		// from doc, insertSorted
		// only test
		assertEquals(0, Arrays.binarySearch(array, 10));
		assertEquals(3, Arrays.binarySearch(array, 40));
		assertEquals(-2, Arrays.binarySearch(array, 18));
		assertEquals(-5, Arrays.binarySearch(array, 48));
	}
}
